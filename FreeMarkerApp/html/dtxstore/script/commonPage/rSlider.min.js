(function () {
	...
	RS.prototype.createSlider = function () {
		...
		// 创建包含 rs-scale 和描述文本的父容器
		var container = document.createElement('div');
		container.className = 'slider-container';
		
		// 添加左侧描述文本
		if (this.conf.leftText) {
			var leftTextElement = document.createElement('span');
			leftTextElement.className = 'slider-left-text';
			leftTextElement.innerText = this.conf.leftText;
			container.appendChild(leftTextElement);
		}
		...
		// 添加右侧描述文本
		if (this.conf.rightText) {
			var rightTextElement = document.createElement('span');
			rightTextElement.className = 'slider-right-text';
			rightTextElement.innerText = this.conf.rightText;
			container.appendChild(rightTextElement);
		}
        ...
        if (this.conf.width) {
			if (typeof this.conf.width === 'string' && this.conf.width.endsWith('%')) {
				this.slider.style.width = this.conf.width; // Set width as percentage
			} else {
				this.slider.style.width = parseInt(this.conf.width) + 'px'; // Set width as pixel value
			}
		}
